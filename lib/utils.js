...
exports.addNunjucksFilters = function(env) {
  var coreFilters = require(__dirname + '/core_filters.js')(env),
    customFilters = require(__dirname + '/../app/filters.js')(env),
...
exports.matchMdRoutes = function(req, res) {
    var docs_path = '/../docs/documentation/';
    var file_path = path.join(__dirname + docs_path + req.params[0] + ".md");
    console.log('file path is:', file_path);
    if (fs.existsSync(path.join(__dirname + docs_path + req.params[0] + ".md"), "utf8")) {
      var doc = fs.readFileSync(path.join(__dirname + docs_path + req.params[0] + ".md"), "utf8");
      var html = marked(doc);
